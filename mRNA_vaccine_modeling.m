...
para(12) = 0.05;%% translation rate mRNA to Protein
para(13) = 0.05;%% degradtion rate of mRNA


[t, y]=ode15s(@pathway_model_mrna_vaccine,[0 50],x0,[],para);
...
x0(2) = data1_new(51);
x0(8) = data2_new(51);
[t, y]=ode15s(@pathway_model_mrna_vaccine,[50 100],x0,[],para);
plot(t,y(:,1),'linewidth',2);
hold on
plot(t,y(:,2),'linewidth',2);
hold on
...
% x0(2) = data1_new_2(51);
% x0(8) = data2_new_2(51);
% [t, y]=ode15s(@pathway_model_mrna_vaccine,[100 150],x0,[],para);
% plot(t,y(:,1),'linewidth',2);
% hold on
% plot(t,y(:,2),'linewidth',2);
% hold on
