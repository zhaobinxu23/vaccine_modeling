...
x0(2) = data1_new(51);
x0(8) = data2_new(51);
[t, y]=ode15s(@pathway_model_environ_vaccine,[50 500],x0,[],para);
data1 = interp1(t,y(:,2),[100:1:500]);
data2 = interp1(t,y(:,8),[100:1:500]);
...
data_virus = interp1(t,y(:,3),[0:1:100]);

final_protection(i) = max(data_virus);
